...
<head>
    ...
    <style>
        ...
        @media (max-width: 960px) and (orientation: landscape) {
            ...
            .app-title::after{
                content: 'LOADING CONTAINER 24_10';
                font-size: 3vw;
            }
            #right-out {
                font-size: 1.75vw;
        ...
        <header class="header">
            <div class="page-brand">
                <a href="<?=site_url(md5('home'));?>" style="margin: auto">
                    <span class="brand brand-font">SALAN PROJECT</span>
                    <span class="brand-mini brand-font">S</span>
                </a>
            </div>
                        ...
                        if(count($menu['submenu']) > 0) { ?>
                            <li id="<?=$menu['MenuID'];?>">
                                ...
                                <?php foreach($menu['submenu'] as $sub) { ?>
                                    <li>
                                        <a href="<?=site_url(md5($menu['MenuID']) . '/' . md5($sub['MenuID']));?>" title="<?=$sub['MenuName'];?>" style="padding-left: 2em"><i class="sidebar-item-icon la la-<?=$sub['MenuIcon'];?>"></i>
